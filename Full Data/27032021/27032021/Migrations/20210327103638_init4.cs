    ...
    public partial class init4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "SocialToEmployees",
                newName: "IX_SocialToEmployees_SocialId");

            migrationBuilder.RenameIndex(
                name: "IX_SocialToEmployee_EmployeeId",
                table: "SocialToEmployees",
                newName: "IX_SocialToEmployees_EmployeeId");

            migrationBuilder.AddPrimaryKey(
                name: "PK_SocialToEmployees",
                table: "SocialToEmployees",
                column: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ForBlog = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItems_ColorToProducts_ColorToProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItems_ColorToProductId",
                table: "SaleItems",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_SocialToEmployees_Employees_EmployeeId",
                table: "SocialToEmployees",
                column: "EmployeeId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_SocialToEmployees_Socials_SocialId",
                table: "SocialToEmployees",
                column: "SocialId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(
                name: "SocialToEmployees",
                newName: "SocialToEmployee");
            ...
            migrationBuilder.RenameIndex(
                name: "IX_SocialToEmployees_SocialId",
                table: "SocialToEmployee",
                newName: "IX_SocialToEmployee_SocialId");

            migrationBuilder.RenameIndex(
                name: "IX_SocialToEmployees_EmployeeId",
                table: "SocialToEmployee",
                newName: "IX_SocialToEmployee_EmployeeId");
